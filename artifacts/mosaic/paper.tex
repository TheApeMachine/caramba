...
\texttt{MosaicBlockLayer} (\path{layer/mosaic/block.py}) and
\texttt{MosaicNGramCacheLogitsLayer} (\path{layer/mosaic/ngram_cache.py}).
...
Core implementation: \path{layer/mosaic/block.py} and \path{layer/mosaic/ngram_cache.py}.
