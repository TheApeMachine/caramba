...
This appendix reserves space for DBA ablations (null token, tied Q--K, RoPE variants, semantic/geometric dimension splits), executed under the same \texttt{--paper-strict} discipline and reported via \path{eval_ckpt.py}.
