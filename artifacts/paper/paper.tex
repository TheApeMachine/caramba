...
For the checkpoint \texttt{runs/a100\_fw1b\_l22\_decoupled\_s1337\_paper\_strict/ckpt\_step100000.pt}, \path{eval_ckpt.py} (included in the Caramba repository) reports the following held-out language modeling quality on FineWeb-Edu token shards:
