...
try:
    from caramba.kernel.metal import (
...
try:
    from caramba.kernel.triton.adamw_triton import adamw_triton_master_step as _adamw_triton_master_step
    from caramba.kernel.fused_ssm import fused_selective_scan as _fused_selective_scan
    from caramba.kernel.triton.layernorm_triton import layernorm_triton as _layernorm_triton
    from caramba.kernel.triton.rmsnorm_triton import rmsnorm_triton as _rmsnorm_triton
    from caramba.kernel.triton.rope_triton import rope_triton as _rope_triton
except Exception as e:
