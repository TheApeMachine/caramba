"""Tools implemented using the Model Context Protocol (MCP).

This module provides tools for the agents to use. A tool can be any
behavior that can be implemented in Python.
Each tool is deployed as a Docker container using the docker compose file.
"""
