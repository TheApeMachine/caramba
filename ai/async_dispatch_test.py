...
from ai.connection import RemoteAgent
...
async def test_root_agent_async_dispatch():
    ...
    with patch("ai.root.PersonaLoader") as mock_loader, \
         patch("ai.root.TeamLoader") as mock_team_loader:
...
async def test_lead_agent_async_dispatch():
    ...
    with patch("ai.lead.PersonaLoader") as mock_loader, \
         patch("ai.lead.TeamLoader") as mock_team_loader:
