...
import toastsReducer, { type ToastAction } from "./toastsReducer";
...
export const NodeEditor = React.forwardRef(
    (
        ...
        const [stageState, dispatchStageState] = React.useReducer(
            stageReducer,
            {
                scale:
                    typeof initialScale === "number"
                        ? clamp(initialScale, 0.1, 7)
                        : 1,
                translate: { x: 0, y: 0 }
            }
        );
