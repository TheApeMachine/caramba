        ...
        with Profile() as pr:
            ...
            with torch.inference_mode():
                for batch in loader:
                    ...
                    if check_every > 0 and (num_batches == 0 or (num_batches % check_every == 0)):
                        try:
                    ...
                    if logits is None:
                        raise ValueError("Model did not return logits for perplexity computation")
                    ...
                    # IMPORTANT: compute CE exactly once per batch.
                    if ignore_index is None:
                        ...
                        # Count non-ignored tokens for the denominator.
                        batch_tokens = int((y_1d != int(ignore_index)).sum().item())
