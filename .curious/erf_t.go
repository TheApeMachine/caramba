...
func erfF(value float32) float32 {
...
func main() {
	...
	fmt.Println("t", t, "erf sim", erfF(t), "go erf", float32(math.Erf(float64(t))))
	fmt.Println("gelu ref", cpumath.FastGelu32(x))
	halfX := 0.5*x
	fmt.Println("gelu sim", halfX*erfF(t)+halfX)
}
