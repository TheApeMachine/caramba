//go:build ignore
package main
import ("fmt"; "math"; cpumath "github.com/theapemachine/caramba/pkg/backend/device/cpu/math")
func metalErfF32(value float32) float32 {
...
func main() {
	...
	fmt.Println("t", t, "metal erf", metalErfF32(t), "go erf", float32(math.Erf(float64(t))))
	fmt.Println("gelu ref", cpumath.FastGelu32(x), "gelu metal", 0.5*x*(1+metalErfF32(t)))
}
