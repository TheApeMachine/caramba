...
smscale_avx512_w8:
	...
	ADDQ $32, DI
	SUBQ $8, CX
	JMP smscale_avx512_w8
smscale_avx512_w4:
	CMPQ CX, $4
	JL smscale_avx512_scalar
	VMOVUPS (SI), X0
	VMULPS X8, X0, X0
	VMOVUPS X0, (DI)
	ADDQ $16, SI
	ADDQ $16, DI
	SUBQ $4, CX
	JMP smscale_avx512_w4
smscale_avx512_scalar:
	TESTQ CX, CX
	JZ smscale_avx512_done
smscale_avx512_sloop:
	MOVSS (SI), X0
	VMULPS X8, X0, X0
	MOVSS X0, (DI)
	ADDQ $4, SI
...
reduce_max_avx512_sloop:
	MAXSS (SI), X0
	ADDQ $4, SI
	DECQ CX
	JNZ reduce_max_avx512_sloop
	JMP reduce_max_avx512_done
