...
TEXT ·SwiGLUPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
...
TEXT ·LinGLUPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
	MOVQ halfCount+24(FP), R9
...
TEXT ·ReGLUPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
	MOVQ halfCount+24(FP), R9
...
TEXT ·GLUPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
	MOVQ halfCount+24(FP), R9
...
TEXT ·SiGLUPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
	MOVQ halfCount+24(FP), R9
...
TEXT ·SeGLUPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
	MOVQ halfCount+24(FP), R9
...
TEXT ·GeGLUPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
	MOVQ halfCount+24(FP), R9
...
TEXT ·GeGLUTanhPackedF32AVX512(SB), NOSPLIT, $32-28
	MOVQ dst+0(FP), DI
	MOVQ packed+8(FP), SI
	MOVQ batch+16(FP), BX
	MOVQ halfCount+24(FP), R9
