...
func mapBackendMethodToKernelName(methodName string) string {
	...
	case "HawkesIntensity":
		return "hawkes_intensity"
	case "HawkesKernelMatrix":
		return "hawkes_kernel_matrix"
	case "HawkesLogLikelihood":
...
var knownKernelNames = map[ir.OpType][]string{
	...
	"hawkes.kernel_matrix":         {"hawkes_kernel_matrix"},
	"hawkes.log_likelihood":        {"hawkes_log_likelihood"},
	"math.sin":                     {"sin"},
	"math.cos":                     {"cos"},
