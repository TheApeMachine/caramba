...
func (rope *RoPE) Forward(stateDict *state.Dict) (*state.Dict, error) {
	...
	output, err := rope.positional.RoPEForwardAtModeConfig(
		rotary.Config{
			Base:                          defaultXLAFloat(stateDict.Base, 10000),
...
func (convolution *Conv2D) Forward(stateDict *state.Dict) (*state.Dict, error) {
	...
	output, err := convolution.convolution.Conv2d(
		...
		defaultXLAInt(defaultXLAInt(stateDict.StrideH, stateDict.Stride), 1),
		defaultXLAInt(defaultXLAInt(stateDict.StrideW, stateDict.Stride), 1),
		stateDict.PadH, stateDict.PadW,
		defaultXLAInt(defaultXLAInt(stateDict.DilationH, stateDict.Dilation), 1),
		defaultXLAInt(defaultXLAInt(stateDict.DilationW, stateDict.Dilation), 1),
...
func (convolution *Conv3D) Forward(stateDict *state.Dict) (*state.Dict, error) {
	...
	output, err := convolution.convolution.Conv3d(
		...
		defaultXLAInt(stateDict.KernelH, stateDict.KernelSize),
		defaultXLAInt(stateDict.KernelW, stateDict.KernelSize),
		defaultXLAInt(defaultXLAInt(stateDict.StrideD, stateDict.Stride), 1),
		defaultXLAInt(defaultXLAInt(stateDict.StrideH, stateDict.Stride), 1),
		defaultXLAInt(defaultXLAInt(stateDict.StrideW, stateDict.Stride), 1),
		stateDict.PadD, stateDict.PadH, stateDict.PadW,
		defaultXLAInt(defaultXLAInt(stateDict.DilationD, stateDict.Dilation), 1),
		defaultXLAInt(defaultXLAInt(stateDict.DilationH, stateDict.Dilation), 1),
		defaultXLAInt(defaultXLAInt(stateDict.DilationW, stateDict.Dilation), 1),
