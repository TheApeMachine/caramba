...
func conv3dForward(
	...
	if useAVX2 && useFMA {
		conv3dAVX2(out, x, weight, bias, n, inC, d, h, w, outC, kD, kH, kW, sD, sH, sW, pD, pH, pW, dilD, dilH, dilW, groups, dOut, hOut, wOut)
	} else {
		conv3dSSE2(out, x, weight, bias, n, inC, d, h, w, outC, kD, kH, kW, sD, sH, sW, pD, pH, pW, dilD, dilH, dilW, groups, dOut, hOut, wOut)
	}
