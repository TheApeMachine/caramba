...
*/
func (pr *PR) encode(artifact *datura.ArtifactBuilder, v any) (err error) {
...
*/
func (pr *PR) GetPR(artifact *datura.ArtifactBuilder) (err error) {
...
Returns an error if the retrieval fails.
*/
func (pr *PR) ListPRs(artifact *datura.ArtifactBuilder) (err error) {
...
*/
func (pr *PR) CreatePR(artifact *datura.ArtifactBuilder) (err error) {
...
*/
func (pr *PR) UpdatePR(artifact *datura.ArtifactBuilder) (err error) {
...
*/
func (pr *PR) CreatePRComment(artifact *datura.ArtifactBuilder) (err error) {
...
Returns an error if the retrieval fails.
*/
func (pr *PR) ListPRComments(artifact *datura.ArtifactBuilder) (err error) {
...
Returns an error if the comment creation fails.
*/
func (pr *PR) CreateReviewComment(artifact *datura.ArtifactBuilder) (err error) {
...
Returns an error if the retrieval fails.
*/
func (pr *PR) ListReviewComments(artifact *datura.ArtifactBuilder) (err error) {
...
*/
func (pr *PR) CreatePRReview(artifact *datura.ArtifactBuilder) (err error) {
...
Returns an error if the retrieval fails.
*/
func (pr *PR) ListPRReviews(artifact *datura.ArtifactBuilder) (err error) {
...
*/
func (pr *PR) SubmitReview(artifact *datura.ArtifactBuilder) (err error) {
	review := &github.PullRequestReviewRequest{
		Body:  github.Ptr(datura.GetMetaValue[string](artifact, "body")),
		Event: github.Ptr(datura.GetMetaValue[string](artifact, "event")), // APPROVE, REQUEST_CHANGES, COMMENT
	}
