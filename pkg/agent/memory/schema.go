...
type MemoryDocument struct {
	...
	Metadata map[string]interface{} `json:"metadata" jsonschema:"type=object" jsonschema_description:"Additional information about this memory"`
}
...
type MemoryEntity struct {
	...
	Metadata     map[string]interface{} `json:"metadata" jsonschema:"type=object" jsonschema_description:"Additional information about this entity relationship"`
}
